...
load test3ROM_10sin50t_r2.mat r_tip_ROM % ROM simulation data
...
hold on
plot(tspan,r_tip_ROM(:,1),'-b','linewidth',1.5)
plot(0.005:0.005:2,x_true+1,'--k','linewidth',1.5)
xlabel('$t$ [s]','FontSize',16,'Interpreter','latex')
ylabel('$x_{\textrm{tip}}$ [m]','FontSize',16,'Interpreter','latex')
grid on
legend('FOM: $n=10$','ROM: $r=1$','Ground Truth','FontSize',14,'Interpreter','latex')
set(gcf, 'Position',  [500, 500, 1000, 250])
figure
plot(tspan(1:10:end),r_tip(1:10:end,3),'-r','linewidth',2)
hold on
plot(tspan,r_tip_ROM(:,3),'-b','linewidth',1.5)
